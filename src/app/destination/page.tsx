...
function DestinationPage() {
  ...
  //useMemo es un hook que memoriza un valor. useMemo es útil cuando necesitas hacer un cálculo costoso para devolver un valor, y quieres asegurarte que el cálculo solamente se ejecute cuando sea necesario. Al memoizar el valor usando useMemo, puedes asegurarte que el valor se ejecute solamente cuando sus dependencias cambien.
